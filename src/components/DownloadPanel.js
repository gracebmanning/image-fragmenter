...
export default function DownloadPanel({ downloadFunctions, allBusy, noBg }) {
    ...
    return (
        <>
            ...
            {noBg && <p className="w-full text-xs text-center">*Background is not transparent in video download.</p>}
        </>
    );
}
